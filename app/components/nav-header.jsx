...
const NavHeader = ({ logo: { url }, name, navHeader: { navigation } }) => {
	...
	return (
		...
		<nav className="mx-auto px-4 py-5 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
			<div class="relative flex items-center justify-between">
				...
				<div class="lg:hidden">
					...
					<button
						...
						title="Open Menu"
						class="-mr-1 rounded p-2 transition duration-200 hover:bg-content focus:bg-content focus:shadow focus:outline-none"
						onClick={() => setIsMenuOpen(true)}
					>
						<svg class="w-5 text-content" viewBox="0 0 24 24">
							<path
								fill="currentColor"
					...
					{isMenuOpen && (
						<div class="absolute left-0 top-0 w-full">
							<div class="rounded border bg-highlight-alt p-5 shadow">
								<div class="mb-4 flex items-center justify-between">
									...
									<div>
										<button
											...
											title="Close Menu"
											class="-mr-2 -mt-2 rounded p-2 transition duration-300 hover:bg-content focus:bg-content focus:shadow focus:outline-none"
											onClick={() => setIsMenuOpen(false)}
										>
											<svg class="w-5 text-content-alt" viewBox="0 0 24 24">
												<path
													fill="currentColor"
