...
/* retrieve the create review page data */
export const qryDataPageCreateReview = gql`
	query qryDataPageCreateReview {
		pages(where: { slug: "create-review" }) {
			title
			slug
			metaDescription
			hero {
...
/* retrieve the reviews page data */
export const qryDataPageReviews = gql`
	query qryDataPageReviews {
		pages(where: { slug: "reviews" }) {
			title
			slug
			metaDescription
			hero {
...
/* retrieve client reveiews data */
export const qryDataReviews = gql`
	query qryDataReviews {
		reviews {
			reviewerBusinessName
			reviewerName
			reviewerImage {
				url
			}
